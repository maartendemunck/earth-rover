    ...
    class ConfiguredServo {
      ...
      public:
        ...
        struct Configuration {
            ...
            bool enforce_pulse_width_limits;  //!< Enforce the minimum and maximum pulse widths when
                                              //!< calling setPulseWidth.
             ...
             *  \param enforce_pulse_width_limits Enforce the minimum and maximum pulse widths when
             * calling setPulseWidth.
             */
            Configuration(uint16_t minimum_pulse_width, uint16_t center_pulse_width,
      ...
      public:
         ...
         *  \param enforce_pulse_width_limits True to enforce the pulse width limits in
         * setPulseWidth calls.
         */
        ...
        //! Initialize the servo using the default configuration or the configuration specified in
        //! the constructor.
        void setup();
        ...
        /*!
         *  \param pulse_width Pulse width. If enforcing pulse widths, this pulse width is limited
         ...
         */
        bool isConfigurationChanged() { return changed; }

        //! Reset the configuration changed flag.
        void resetConfigurationChanged() { changed = false; }
      ...
      private:
         ...
         *  \return Corrected pulse width if enforcing pulse width limits; requested pulse width if
         * not.
         */
