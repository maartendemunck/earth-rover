...
namespace earth_rover_vcu {
    ...
    /*!
     *  The radio configuration is stored in a separate (this) class to uniformize storing and
     * restoring configuration and calibration settings.
     *
     *  \ingroup VCU
     */
    class RadioConfiguration {
      private:
        ...
        bool save_required{
            false};  //!< True if the radio configuration should be written to EEPROM.
      ...
      public:
         ...
         */
        uint8_t getHmiRadioPowerLevel() { return hmi_radio_power_level; }
         ...
         */
        uint8_t getVcuRadioPowerLevel() { return vcu_radio_power_level; }
